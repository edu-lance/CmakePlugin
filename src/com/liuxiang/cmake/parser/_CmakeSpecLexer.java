 ...
 * from the specification file <tt>cmakespec.flex</tt>
 */
class _CmakeSpecLexer implements FlexLexer {
...
private String matchedText() {
   ...
   */
  _CmakeSpecLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 9: break;
          case 5: 
            { return new CmakeElementType(CmakeElementType.TYPE_REQUIRED,CmakeLanguage.CMAKE);
            }
          case 10: break;
          default:
